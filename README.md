...
![](http://owklx3f60.bkt.clouddn.com//17-12-11/15397734.jpg)
...
2. $root
    ...
    用来访问当前组件树的根实例，如果当前实例没有父实例，$root表示当前组件实例本身。
3. $children

    用来访问当前组件实例的直接子组件实例。
4. $refs

    用来访问使用了`v-ref`指令的子组件。
...
![](http://owklx3f60.bkt.clouddn.com//17-12-11/29941853.jpg)